const CATS = [
  {
    ...
    items: ["Sisa Makanan", "Daun Kering", "Kulit Buah", "Sayuran", "Kertas Daur Ulang", "Ranting Pohon", "Ampas Kopi"],
  ...
  },
  {
    ...
    items: ["Botol Plastik", "Kaleng", "Kertas Bebas", "Kaca", "Logam", "Kardus", "Botol Kaca", "Aluminium", "Besi Tua", "Tembaga"],
  ...
  },
  {
    ...
    items: ["Styrofoam", "Popok Bekas", "Masker", "Plastik Berlapis", "Pembalut", "Baterai Bekas", "Puntung Rokok", "Kemasan Sachet"],
